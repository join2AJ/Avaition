          ...
          <Protected>
            <Shell>
              <Routes>
                ...
                <Route path="applications" element={<Placeholder title="Applications" note="Category-driven checklist, clarification loop and committee scheduling across MAN, MATERIAL and VEHICLE pillars. Building next." />} />
